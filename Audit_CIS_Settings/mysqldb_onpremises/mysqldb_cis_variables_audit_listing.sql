...
select  @@global.version as version_database,
       ...
       'set global log_bin_basename = ''/$path/binlogs/mysql_bin'';' as action_cmd      
union       
select  @@global.version as version_database,
	   'File System Permissions' as cis_category, 
...
select  @@global.version as version_database,
	   ...
	   case when @@global.slow_query_log = 0 
	        then 'no action needed'
			else 'SET GLOBAL slow_query_log_file = ''/$path/logs/mysql_slowquery.log'';' 
	   end as action_cmd      
union
select  @@global.version as version_database,
	   'File System Permissions' as cis_category, 
	   ...
	   'SET GLOBAL relay_log_basename = ''/$path/binlogs/relay_bin'';' as action_cmd
union 	   
select @@global.version as version_database,
	   'File System Permissions' as cis_category, 
...
select  @@global.version as version_database,
	   ...
	   'SET GLOBAL general_log_file = ''/$path/logs/mysql_general.log'';'  as action_cmd
union 	   
/* General */
select  @@global.version as version_database,
...
select  @@global.version as version_database,
	   ...
	   CASE WHEN @@global.secure_file_priv = '' and @@global.local_infile = 0
	        THEN 'no action needed'
	        ELSE 'set global secure_file_priv = ''/$path/backup'';'
            END AS action_cmd  
union
/* MySql Permissions */ 
SELECT  @@global.version as version_database,
