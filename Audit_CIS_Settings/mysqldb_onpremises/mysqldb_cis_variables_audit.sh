...
#
mysql -h $hostname -sN -u root -p$password < mysqldb_cis_variables_audit_listing_nok_directory.sql >> results_audit/result_mysqldb_cis_variables_audit_change_directory.sql
#
